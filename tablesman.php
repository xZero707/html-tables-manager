...
/**
 *  ~ Tables Manager v2.1.1 ~
 * Made for easier manipulation with messy HTML tables
 * 
 * @version 2.1.1
 * @since 2.0.0 Not backwards compatible
...
class tablesman {
    ...
    {
        $this->generator = (($val) ? $this->EOL . "<!-- {$val} -->" . $this->EOL : '');
    }
    ...
    { 
        $this->EOL = (($this->readOpt("NEW_LINE") === false) ? '' : PHP_EOL);
    }
